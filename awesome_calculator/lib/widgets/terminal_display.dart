                ...
                children: [
                  ...
                  SingleChildScrollView(
                    ...
                    onTapDown: (details) {
                      ...
                      final clickedPosition = position.offset.clamp(0, terminalText.length);

                      // Only allow clicking within current input section (after current prompt)
                      final minPosition = currentPromptPosition + promptSymbol.length;
                      final newPosition = clickedPosition.clamp(minPosition, terminalText.length);
                    ...
                    child: RichText(
                      text: TextSpan(
                        ...
                        children: [
                          TextSpan(
                            text: terminalText.substring(0, cursorPosition),
                          ),
                          WidgetSpan(
                            ...
                            child: Container(
                              width: 12,
                              height: 24,
                              color: showCursor ? const Color(0xFF00FF00) : Colors.transparent,
                            ),
                          ),
                          TextSpan(
